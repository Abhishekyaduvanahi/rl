...
export const about={
  name:"Hello, I'm Radhika Lahre 🙋‍♀️",
...
description:" Develop and Maintain Official Web Sites: Assist in creating and updating responsive web pages.  Giving Training to Fresher trainees. Team leading: Handling over 200 trainees daily for projects. Collaborate with Team Members: Work closely with designers and developers to understand project requirements and providefeedback. Test and Debug Applications: Participate in testing web applications for performance and compatibility, and assist in debugging any issues."
}
...
export const experience2={
  ...
  description:"Develop and Maintain Web Pages: Assist in creating and updating responsive web pages using HTML, CSS, and Tailwind CSS. Build React Components: Help design and implement reusable componentsin ReactJS to enhance application functionality. Implement JavaScript Features: Add interactive features and troubleshoot issuesin web applications using JavaScript. Test and Debug Applications: Participate in testing web applications for performance and compatibility, and assist in debugging any issues."
  }
  ...
  export const experience3={
    ...
    description:" Preparing MIS reports on Weekly & Monthly basis. Making Auto MIS Reports from ERP processes. Making Various FMS, IMS, Check list in Google Sheets for various Dept. and as per needs. Working on Delegation Sheets. Working on WhatsApp Bot. Creating Google Forms as per requirement. Creating Checklist on Data Studio. Working on YouTube Channel and Video "
    }
